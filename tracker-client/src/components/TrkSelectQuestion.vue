<template>
  <ion-item>
    ...
    <ion-select v-model="localState.answer">
      <ion-select-option
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const localDebugLog = (message: string): void => {
      logger.debug(`TrkSelectQuestion - ${props.properties.questionPrompt} (${props.properties.questionId}) - ${message}`);
    }
