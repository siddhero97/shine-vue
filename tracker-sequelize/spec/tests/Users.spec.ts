...
describe('Users Routes', () => {
    ...
    describe(`"GET:${getUsersPath}"`, () => {
        ...
        it(`should return a JSON object with all the users and a status code of "${OK}" if the
            ...
            // Setup spy
            const users = [
                new User({displayName: 'Sean', mobile_phone: '604-555-5555', email: 'a@a.com'}),
                new User({displayName: 'John', mobile_phone: '604-555-5555', email: 'a@a.com'}),
                new User({displayName: 'Melanie', mobile_phone: '604-555-5555', email: 'a@a.com'}),
            ];
            ...
            agent.get(getUsersPath)
                .end((err: Error, res: IResponse) => {
                    ...
                    const retUsers: User[] = respUsers.map((user: UserAttributes) => {
    ...
    describe(`"POST:${addUsersPath}"`, () => {
        ...
        const userData = {
            user: new User({
                displayName: 'Melanie', mobile_phone: '604-555-5555', email: 'a@a.com'
            }),
        };
